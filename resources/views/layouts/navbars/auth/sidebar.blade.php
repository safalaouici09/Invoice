...
<aside id="default-sidebar"
    ...
    <div
        ...
        <a href="#" class="flex mr-4 mb-10">
            <img src="https://flowbite.s3.amazonaws.com/logo.svg" class="mr-3 h-8" alt="FlowBite Logo" />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Flowbite</span>
        </a </li>
        <ul class="space-y-2">

            <a href="{{ url('simulateur') }}"
                class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
                    {{ Request::is('simulateur') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '' }}">
                ...
                <span class="ml-3">Simulateur</span>
            </a>
            ...
            <li>
                <a href="{{ url('absences') }}"
                    class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
                  {{ Request::is('absences') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '' }}">
                    <svg aria-hidden="true"
            ...
            <li>
                <a href="{{ url('emploi-du-temps') }}"
                    class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
                {{ Request::is('emploi-du-temps') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '' }}">
                    <svg aria-hidden="true"
                        class="w-6 h-6 text-gray-400 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path>
