                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @foreach ($data as $index => $item)
                            <tr wire:key='data-{{ $item['ordre'] }}' class="border-b dark:border-gray-700">
                                <th scope="row"
                                    class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ $item['eleve'] }}</th>
                                <td class="px-4 py-3">{{ $item['date_cours'] }}</td>
                                <td class="px-4 py-3">{{ $item['heure_debut'] . ' - ' . $item['heure_fin'] }}</td>
                                <td class="px-4 py-3">{{ $item['matiere_designation'] }}</td>
                                <td class="px-4 py-3">


                                    @if ($item['is_absent'] == 1 || $item['is_retard'] == 1)
                                        @if ($item['is_absent'] == 1)
                                            <span
